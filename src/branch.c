...
int git_branch_upstream_name_from_merge_remote_names(
	git_buf *out,
	git_repository *repo,
	...
	const char *refname)
{
	...
	error = git_branch_upstream_name_from_merge_remote_names(out, repo, git_buf_cstr(&remote_name), git_buf_cstr(&merge_name));
